...
export const SQUAD_RULES: { title: string; body: string }[] = [
  ...
  { title: "Only 5 subs score", body: "Just like the real thing, only five substitutes can score for you. The five earliest subs to come on from your bench earn points; any sub who comes on after those five is locked at 0 points for that gameweek no matter what they do in the match. Subs who never get on also score 0." },
  ...
  { title: "What scores points", body: "Points come from goals (6 for a keeper or defender, 5 for a midfielder, 4 for a forward), assists (3), every shot (1 each), every shot on goal that wasn't a goal (1 each, on top of the shot point), saves (1 each), shots on goal faced by your keeper (1 each), goals conceded by your keeper (−1 each), clean sheets, penalties saved and missed, yellow and red cards, own goals and a man-of-the-match bonus. The full table, including the halved sub values, is on the Scoring tab." },
...
export const SCORING_RULES: {
  ...
  { abbr: "SOG", label: "Shots on goal that weren't goals (on top of the shot point)", minTime: "1+ sec", starter: "1 pt", sub: "0.5 pt" },
...
> = {
  ...
  shots_on_target: { abbr: "SOG", means: "Shots on goal (goals excluded when scoring)", points: 1 },
