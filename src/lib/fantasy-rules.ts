...
export const SQUAD_RULES: { title: string; body: string }[] = [
  ...
  { title: "Subs score too", body: "Any starter who doesn't play scores 0. Every named sub who comes on scores their normal points plus sub points (+1 for coming on, +1 for 30+ minutes off the bench, +1 for a goal or assist off the bench), all added to your gameweek total. Subs who stay on the bench score 0." },
