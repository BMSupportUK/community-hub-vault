...
export const SQUAD_RULES: { title: string; body: string }[] = [
  ...
  { title: "Two-position players", body: "A player who can play in two positions (for example a forward who can also play in midfield) is scored in the position of the slot you pick him in — a midfield slot pays midfielder points (5 a goal, plus the midfielder clean-sheet point), a forward slot pays forward points. On a flexible slot you choose which of his two positions he plays as, and subs are scored in their main listed position." },
  { title: "Deadline", body: `Entries lock ${FANTASY_LOCK_MINUTES / 60} hours before kick-off. After that no new players can come in or out of your squad.` },
  { title: "Late sub swaps", body: `Once the gameweek locks you can still swap your named subs with your match day 11 — including changing formation and captain to suit — right up until ${FANTASY_FINAL_SWAP_MINUTES} minutes before kick-off. No other changes are allowed in that window: the 18 players you named at the deadline are fixed. At ${FANTASY_FINAL_SWAP_MINUTES} minutes before kick-off your team is final.` },
