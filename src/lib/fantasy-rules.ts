...
export const SQUAD_RULES: { title: string; body: string }[] = [
  ...
  { title: "What scores points", body: "Points come from goals (6 for a keeper or defender, 5 for a midfielder, 4 for a forward), assists (3), shots (1 each), saves (1 each), goals conceded by your keeper (−1 each), clean sheets, penalties saved and missed, yellow and red cards, own goals and a man-of-the-match bonus. The full table, including the halved sub values, is on the Scoring tab." },
  ...
  { title: "Scoring & prizes", body: "Only Middlesbrough players score. Every point is built from the stats in the official ESPN match report, so points are worked out automatically once the game finishes and the stats are confirmed, and can be checked against the match report. Starters score the full amount and subs score half. Winners are announced on the Winners tab at the end of the season — see the Scoring tab for the full points breakdown." },
];
...
export const SCORING_RULES: {
  ...
  { label: "Clean sheet (under 60 mins) — goalkeeper or defender", minTime: "1+ sec", starter: "2 pts", sub: "1 pt" },
  { label: "Clean sheet (under 60 mins) — midfielder", minTime: "1+ sec", starter: "0.5 pt", sub: "0.25 pt" },
