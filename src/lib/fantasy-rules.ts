...
export const SQUAD_RULES: { title: string; body: string }[] = [
  ...
  { title: "Sub bench", body: `The Sky Bet Championship, the FA Cup and the Carabao Cup all allow a bench of ${FANTASY_BENCH_SIZE}, so you name ${FANTASY_BENCH_SIZE} subs alongside your 11 for a ${FANTASY_SQUAD_SIZE}-man squad. Sub 1 is reserved for your replacement goalkeeper, so at least ${FANTASY_BENCH_MIN_GK} goalkeeper is always on the bench, and the other ${FANTASY_BENCH_SIZE - FANTASY_BENCH_MIN_GK} are outfield players of your choosing.` },
  ...
  { title: "Subs score half", body: "Where you named the player decides what they earn: anyone in your match day 11 who features earns 2 points for the appearance and the full points for every match stat. A sub who comes off your bench earns 1 point for the appearance and exactly half points for every match stat. Half and quarter points are kept and are not rounded. Starters who don't play and subs who stay on the bench score 0." },
