...
export const SCORING_RULES: {
  ...
  { label: "Goal (G) — goalkeeper or defender", minTime: "1+ sec", starter: "6", sub: "3" },
  { label: "Goal (G) — midfielder", minTime: "1+ sec", starter: "5", sub: "2.5" },
  { label: "Goal (G) — forward", minTime: "1+ sec", starter: "4", sub: "2" },
  { label: "Assist (A)", minTime: "1+ sec", starter: "3", sub: "1.5" },
  { label: "Big chance created (BCC)", minTime: "1+ sec", starter: "3", sub: "1.5" },
  { label: "Big chance missed (BCM)", minTime: "1+ sec", starter: "-2", sub: "-1" },
  ...
  { label: "Shot on goal that isn't a goal (SOG)", minTime: "1+ sec", starter: "1", sub: "0.5" },
  { label: "Every 3 shots (SHOT)", minTime: "1+ sec", starter: "1", sub: "0.5" },
  { label: "Every 20 accurate passes (AC.PASS)", minTime: "1+ sec", starter: "1", sub: "0.5" },
  { label: "Pass accuracy 85%+ on 20+ passes (PASS / PASS%)", minTime: "1+ sec", starter: "2", sub: "1" },
  { label: "Pass accuracy 75-84% on 20+ passes (PASS / PASS%)", minTime: "1+ sec", starter: "1", sub: "0.5" },
  { label: "Every 3 accurate long balls (AC.LONG)", minTime: "1+ sec", starter: "1", sub: "0.5" },
  { label: "Every 25 touches (TCH)", minTime: "1+ sec", starter: "1", sub: "0.5" },
  { label: "Every 4 duels won (DUELW)", minTime: "1+ sec", starter: "1", sub: "0.5" },
  ...
  { label: "Penalty save", minTime: "1+ sec", starter: "5", sub: "2.5" },
  { label: "Penalty miss", minTime: "1+ sec", starter: "-2", sub: "-1" },
  { label: "Every 2 goals conceded (GA) — goalkeeper or defender", minTime: "1+ sec", starter: "-1", sub: "-0.5" },
  ...
  { label: "Man of the match bonus (awarded by admin)", minTime: "1+ sec", starter: "3", sub: "1.5" },
...
export const STAT_KEY: { stat: string; means: string }[] = [
  ...
  { stat: "G — Total Goals", means: "Goals scored by the player." },
  { stat: "A — Assists", means: "Passes or touches that directly set up a team-mate's goal." },
  { stat: "SHOT — Shots", means: "Every attempt at goal, on or off target." },
  { stat: "SOG — Shots on Goal", means: "Attempts on target — saved, blocked on the line or scored." },
  ...
  { stat: "GA — Goals Conceded", means: "Goals Middlesbrough conceded while the player was on the pitch." },
  ...
  { stat: "PASS — Passes", means: "Total passes attempted by the player." },
  { stat: "AC.PASS — Accurate Passes", means: "Passes that found a team-mate." },
  { stat: "PASS% — Pass Percentage", means: "Share of the player's passes that were accurate." },
  { stat: "AC.LONG — Accurate Long Balls", means: "Long passes (over roughly 30 yards) that found a team-mate." },
  { stat: "BCC — Big Chances Created", means: "Passes that handed a team-mate a clear scoring chance." },
  { stat: "BCM — Big Chances Missed", means: "Clear scoring chances the player failed to convert." },
  { stat: "TCH — Touches", means: "Every time the player touched the ball." },
  { stat: "DUELW — Duels Won", means: "Ground and aerial contests the player came out on top of." },
