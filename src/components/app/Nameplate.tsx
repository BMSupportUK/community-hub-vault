  ...
  return (
    ...
    >
      ...
      {np?.animation_class === "nameplate-corgi" && (
        <>
          <span className="nameplate-corgi-paw" aria-hidden>🐾</span>
          <span className="nameplate-corgi-paw p2" aria-hidden>🐾</span>
          <span className="nameplate-corgi-tail" aria-hidden>〰️</span>
