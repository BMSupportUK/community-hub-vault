...
export function ScreenLockOverlay({ settings, onUnlock }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[200] overflow-hidden">
      ...
      <div className="absolute left-1/2 top-[46%] w-[92%] -translate-x-1/2 -translate-y-1/2 sm:w-[70%] md:w-[50%] lg:w-[34%] xl:w-[30%] max-w-[420px] rounded-2xl border border-primary/40 bg-background/75 backdrop-blur-2xl shadow-[0_0_60px_-10px_hsl(var(--primary)/0.7)] overflow-hidden">
