    ...
    <main className="flex-1 overflow-y-auto">
      <section className="relative overflow-hidden border-b border-border">
        ...
        <div className="relative p-6 md:p-10 text-white">
          <Link to={backTo} className="inline-flex items-center gap-1 text-xs text-white/70 hover:text-white mb-3">
            <ArrowLeft className="size-3.5" /> {backTo === "/forum" ? "Back to Boro Fan Zone" : "Back"}
          </Link>
