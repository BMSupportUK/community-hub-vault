...
export function ReviewsPage() {
  ...
  return (
    <div
      className="relative flex-1 overflow-visible md:h-full md:min-h-0 md:overflow-y-auto md:scrollbar-hide bg-[#1a0b2e] bg-cover bg-center bg-no-repeat bg-fixed"
