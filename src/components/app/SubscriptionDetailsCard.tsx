  ...
  return (
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-lg max-h-[85vh] overflow-y-auto p-0 gap-0 border-violet-500/40">
          <DialogHeader className="px-5 py-4 bg-gradient-to-br from-violet-600 via-fuchsia-600 to-blue-600 text-white space-y-0.5">
            <DialogTitle className="font-display font-bold text-lg flex items-center gap-2 text-white">
              <CalendarClock className="size-5" /> Your Subscription Details
            </DialogTitle>
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="flex items-center gap-2">
                          <input
                            ...
                            className="flex-1 px-2 py-1.5 rounded-md bg-background border border-border text-xs"
                          />
                          <CopyButton
