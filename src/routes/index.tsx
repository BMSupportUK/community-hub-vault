  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 px-6 py-10 md:py-16">
        <section
          className="relative max-w-7xl mx-auto rounded-3xl border border-red-900/60 p-6 md:p-10 lg:p-12 pb-40 md:pb-44"
          style={{
            background:
        ...
        <div className="relative max-w-7xl mx-auto -mt-20 md:-mt-24 px-10 md:px-14 grid grid-cols-1 sm:grid-cols-3 gap-4 z-10">
          {boxes.map((b) => (
            <div
              key={b.id}
