  ...
  return (
    <div className="min-h-screen md:h-screen md:overflow-hidden bg-background flex flex-col">
      ...
      <main className="flex-1 min-h-0 md:overflow-hidden px-6 py-4 md:py-4 [@media(max-height:650px)]:py-2 flex flex-col gap-3">
        ...
        >
          <div className="grid md:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)] lg:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)] gap-5 md:gap-3 lg:gap-4 items-center lg:items-stretch w-full">
            ...
            <div className="relative w-full md:-ml-2 lg:-ml-4 lg:h-full">
              ...
              <div className="relative rounded-3xl overflow-hidden border border-white/20 shadow-[0_20px_80px_rgba(0,0,0,0.6)] max-w-[680px] ml-auto lg:h-full">
                <img
                  ...
                  fetchPriority="high"
                  decoding="async"
                  className="block w-full h-auto max-h-[56vh] object-cover lg:h-full lg:max-h-none"
                />
              </div>
            </div>
          </div>
