  ...
  return (
    <div className="min-h-screen md:h-screen md:overflow-hidden bg-background flex flex-col">
      ...
      <main className="flex-1 min-h-0 md:overflow-hidden px-6 py-4 md:py-4 [@media(max-height:650px)]:py-2 flex flex-col gap-3">
        ...
        <section
          className="landing-hero-panel relative min-w-0 rounded-3xl border border-red-900/60 p-4 pb-12 md:p-6 md:pb-14 lg:p-8 lg:pb-16 [@media(max-height:650px)]:p-4 [@media(max-height:650px)]:pb-10 flex-1 flex flex-col justify-center [@media(max-height:650px)]:justify-start"
          style={{
            background:
