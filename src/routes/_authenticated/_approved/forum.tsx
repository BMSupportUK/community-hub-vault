      ...
      <div className="space-y-3 min-w-0">
        ...
        return (
          <Link
              ...
              to="/forum/$board"
              params={{ board: b.slug }}
              className="group flex flex-col rounded-xl border border-border bg-surface-1/55 backdrop-blur-[1px] hover:border-[#E11B22]/70 hover:shadow-[0_10px_30px_-10px_rgba(225,27,34,0.55)] hover:-translate-y-[2px] transition-all overflow-hidden relative h-full"
            >
              <span
...
function ForumStats({ boards }: { boards: Board[] }) {
  ...
  return (
    <div className="rounded-xl border border-[#E11B22]/40 bg-surface-1/55 backdrop-blur-[1px] overflow-hidden shadow-[0_10px_30px_-10px_rgba(225,27,34,0.4)] h-full flex flex-col">
