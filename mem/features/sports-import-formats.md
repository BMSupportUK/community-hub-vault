...
- Scottish Cup region-suffix style: `8:00pm UK / 3:00pm ET`, `QUEEN OF THE SOUTH v RANGERS B`, then `Premier Sports 1 UK` and `Premier Sports 1 IRE` → 20:00 BST, `QUEEN OF THE SOUTH & RANGERS B`, channels `UK Premier Sports 1` and `IRE Premier Sports 1`. The UK and IRE channels are distinct; move the suffix to the front, never discard it. Repair stored guides as well as future imports.
