...
- URC / Premier Sports region-tag style: channel rows `UK | Premier Sports 1` / `IRE | Premier Sports 1` → strip the region tag, keep one `Premier Sports 1`. Region tags (UK, IRE, US, AUS…) before a numbered channel are never channels themselves.
